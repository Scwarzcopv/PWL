...
<head>
    ...
    <title>Week3.2 • Pengolahan Form 2</title>
...
<body>
	<h1 class="text-start translate-middle position-absolute top-50 start-50 text-nowrap">
		<form ACTION="3_proses02.php" METHOD="POST" NAME="input" class="mb-2 mb-lg-4">
			<div class="input-group input-group-lg">
				<span class="input-group-text fw-bolder text-dark">Nama Anda :</span>
				<input type="text" class="form-control me-2 me-lg-3" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg" placeholder="Input Nama Anda" name="nama" required>
