			...
			<div class="row mb-lg-2 h4 d-flex align-items-start">
				...
				<div class="col-lg-8 pt-lg-2">
					<div class="form-check lh-base h4">
						<input class="form-check-input" type="checkbox" name="Catatan1" value="Kehadiran >= 70 %">
						<label class="form-check-label" for="flexCheckDefault">Kehadiran >= 70 %</label>
					</div>
					<div class="form-check lh-base h4">
						<input class="form-check-input" type="checkbox" name="Catatan2" value="Interaktif di kelas">
						<label class="form-check-label" for="flexCheckDefault">Interaktif di kelas</label>
					</div>
					<div class="form-check lh-base h4">
						<input class="form-check-input" type="checkbox" name="Catatan3" value="Tidak terlambat mengumpulkan tugas">
						<label class="form-check-label" for="flexCheckDefault">Tidak terlambat mengumpulkan tugas</label>
					</div>
				</div>
			</div>
			<div class="row">
