...
<head>
    ...
    <title>Week4.22 • String 12</title>
...
<body>
	<h1 class="text-start translate-middle position-absolute top-50 start-50 text-nowrap">
		<form action="" method="post"> 
			<label class="form-label">Intput teks di sini:</label>
  			<textarea class="form-control" name="input" rows="4" cols="80"></textarea>
  			<button type="submit" class="btn-lg btn-primary" name="Submit">Proses</button>
  		</form>
	<?php 
		if (isset($_POST['Submit'])) { 
			$txt = $_POST['input']; 
			echo "<u><br><br>Tanpa nl2br() :</u> <br>$txt<br><br>"; 
			echo "<u>Dengan nl2br :</u> <br>". 
			nl2br ($txt); 
		}
	?>
	</h1>
